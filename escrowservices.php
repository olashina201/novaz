                    ...
                    <aside class="sidebar-area ltn__right-sidebar">
                        ...
                        <div class="widget-2 ltn__menu-widget ltn__menu-widget-2 text-uppercase">
                            <ul>
                                ...
                                <li ><a href="consultingservice.html">Consulting Service <span><i class="fas fa-arrow-right"></i></span></a></li>
                                ...
                                <li class="active"><a href="escrowservices.html">Escrow Services <span><i class="fas fa-arrow-right"></i></span></a></li>
                            </ul>
                        </div>
                        <!-- Newsletter Widget -->
