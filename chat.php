...
<!-- Mirrored from maelectrics.com/tf/html/quarter-preview/quarter/checkout.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 07 Oct 2021 22:25:51 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="x-ua-compatible" content="ie=edge">
    <title>NOVAZ ARC - PROPERTY | ChatT</title>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="ltn__breadcrumb-inner">
                        <h1 class="page-title">Customer's chat</h1>
                    ...
                    <div class="col-xl-3 col-md-6 col-sm-6 col-12">
                        <div class="footer-widget footer-about-widget">
                            <div class="footer-logo">
                              <div class="site-logo">
                                <a href="index.html"><img src="img/Novaz logo.png"  alt="Logo"></a>
                              </div>
                            </div>
                            ...
                            <div class="footer-address">
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <div class="footer-address-info">
                                            <p><a href="tel:+234 903 875 6214">+234 903 875 6214</a></p>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="footer-address-icon">
                                        ...
                                        <div class="footer-address-info">
                                            <p><a href="mailto:example@example.com">info@novazarc.com</a></p>
                                        </div>
                                    </li>
                                </ul>
                            </div>
