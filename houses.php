                        ...
                        <div class="tab-pane fade active show" id="liton_product_grid">
                            <div class="ltn__product-tab-content-inner ltn__product-grid-view">
                                <div class="row ltn__product-slider-item-three-active slick-arrow-1">
                                        ...
                                        $qr = mysqli_query($link, "SELECT * FROM business WHERE cate ='1' AND promotion ='active' ");
...
elseif($rowb['ptype'] == 12) 
{
    ...
    <div class="ltn__modal-area ltn__add-to-cart-modal-area">
        <div class="modal fade" id="liton_wishlist_modalst" tabindex="-1">
                                    ...
                                    <div class="col-12">
                                        <div class="modal-product-img">
                                         ...
                                         <div class="modal-product-info">
                                            <h5><a href="product-details" id="catedescript"></a></h5>
...
<script>
 $(document).ready(function() {
	 $('.view_whilst').click(function (e){
		
		e.preventDefault();
	
	
            var diags = $('#whilst_id').val();
	
			//var diags =  $(this).closest('tr').find('.whilst_id').text();
                ...
                $.ajax({
                     ...
                     success: function(result)  
                    {
						  ...
						  $.each(result, function (key, value){
							 $('#catedescript').val(value['catedescript']); 
 						  });
						  $('#liton_wishlist_modalst').modal('show');
                     }
                });
