		...
		<div class="col-md-8">
			<h2>Upload your images</h2>
			 ...
			 <form method='post' action='' enctype="multipart/form-data">
							<input type="file" id='files1' name="files[]" multiple onChange="processImages(event)"><br>
...
var imagesToLoad="images to load";
	$(document).ready(function(){

		$('#submit').click(function(){
			// alert(imagesToLoad); return;
           ...
           // var totalfiles = document.getElementById('files').files.length;
			...
			// var basename = totalfiles.replace(/\\/g,'/').replace(/.*\//, '');


           // for (var index = 0; index < basename; index++) 
			//{
		...
		$.post("push.php", {images:imagesToLoad}, function(result){
    $("#preview").html(result);
  });
...
{
	let data = document.getElementById("files1").files;
	...
	*/
	...
	//console.log(mappedFiles[0].selectedFile);
	imagesToLoad=JSON.stringify(mappedFiles);
