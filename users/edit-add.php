              ...
              <div class="row">
                    <div class="col-md-1">
                      <div class="form-group">
                        <p><img id="ovo" width="70" height="70" style=" border-style:none;">  </p>
                        <p>
                    ...
                    <div class="col-md-1">
                      <div class="form-group">
                      <p><img id="ive" width="70" height="70" style=" border-style:none;">  </p>
                        <p>
                    ...
                    <div class="col-md-1">
                      <div class="form-group">
                      <p><img id="era" width="70" height="70" style=" border-style:none;">  </p>
                        <p>
                    ...
                    <div class="col-md-1">
                      <div class="form-group">
                      <p><img id="ene" width="70" height="70" style=" border-style:none;">  </p>
                        <p>
                    ...
                    <div class="col-md-1">
                      <div class="form-group">
                      <p><img id="iyori" width="70" height="70" style=" border-style:none;">  </p>
                        <p>
                  ...
                  <div class="col-md-1">
                        <div class="form-group">
                          <p><img id="esa" width="70" height="70" style=" border-style:none;">  </p>
                            <p>
                  ...
                  <div class="col-md-1">
                        <div class="form-group">
                          <p><img id="ighwe" width="70" height="70" style=" border-style:none;">  </p>
                            <p>
                  ...
                  <div class="col-md-1">
                        <div class="form-group">
                          <p><img id="elele" width="70" height="70" style=" border-style:none;">  </p>
                            <p>
                  ...
                  <div class="col-md-1">
                        <div class="form-group">
                          <p><img id="erili" width="70" height="70" style=" border-style:none;">  </p>
                            <p>
                  ...
                  <div class="col-md-1">
                        <div class="form-group">
                          <p><img id="ihwe" width="70" height="70" style=" border-style:none;">  </p>
                            <p>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                     <div class="form-group">
                       ...
                       <textarea class="form-control" name="description" id="description" rows="4" style="width: 100%;"></textarea>
                     </div>
              ...
              <div class="row">
                ...
                <div class="col-md-3">
                     <div class="form-group">
                       ...
                       <input type="text" class="form-control" name="estname" id="estname">
                     </div>
            ...
            <div class="row">
                  ...
                  <label>Price </label> 
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control" name="price" id="price" placeholder="Price in figure">
