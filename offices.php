...
<head>
    ...
    <meta http-equiv="x-ua-compatible" content="ie=edge">
     <title>NOVAZ ARC - PROPERTY MANAGEMENT | Offices</title>
                        ...
                        <div class="tab-pane fade active show" id="liton_product_grid">
                            <div class="ltn__product-tab-content-inner ltn__product-grid-view">
                                <div class="row ltn__product-slider-item-three-active slick-arrow-1">
                                        ...
                                        $qr = mysqli_query($link, "SELECT * FROM business WHERE promotion ='active' AND cate ='6' ");
    ...
    $ptype = 'Room & Parlor';
                ...
                <div class="col-md-3">
                    <div class="ltn__product-item ltn__product-item-4 text-center---">
                        <div class="product-img" style="padding-bottom:5px; margin-bottom:5px; max-height:200px; min-height:200px;">
