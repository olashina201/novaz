...
<!-- Mirrored from maelectrics.com/tf/html/quarter-preview/quarter/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 07 Oct 2021 22:25:52 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="x-ua-compatible" content="ie=edge">
    <title>NOVAZ ARC - PROPERTY MANAGEMENT | Logout</title>
  ...
  <?php include ("navs.php");?>
    ...
    <div id="ltn__utilize-mobile-menu" class="ltn__utilize ltn__utilize-mobile-menu">
        <div class="ltn__utilize-menu-inner ltn__scrollbar">
            <div class="ltn__utilize-menu-head">
                <div class="site-logo">
                    <a href="index.html"><img src="img/Novaz_Logo2.png" alt="Logo"></a>
                </div>
                <button class="ltn__utilize-close">×</button>
            </div>
                ...
                <ul>
                    ...
                    <li><a href="#">Shop</a>
                        <ul class="sub-menu">
                            ...
                            <li><a href="shortlet.html">Shotlet</a></li>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title-area text-center">
                        <h4 class="section-title text-success">You have successfully logout</h4>
                     </div>
                </div>
            </div>
            <div class="row">
